...
function gameLogic(){
	...
	if (pChoice=="rock" && cChoice=="scissors"|| pChoice=="rock" && cChoice=="lizard" || pChoice=="scissors" && cChoice=="lizard" || pChoice=="paper" && cChoice=="rock" || pChoice=="scissors" && cChoice=="paper" || pChoice=="lizard" && cChoice=="spock"|| pChoice=="spock" && cChoice=="rock" || pChoice=="spock" && cChoice=="scissors" || pChoice=="paper" && cChoice=="spock"){
		alert("Computer chose " + cChoice + ", " + pChoice +" beats " + cChoice+ "\n" + playerName + " wins!")
		pScore++;
		alert("Scores:\n Computer: " + cScore + "\n" + playerName + ": " + pScore);
	}
	 else if (cChoice=="rock" && pChoice=="scissors"|| cChoice=="rock" && pChoice=="lizard" || cChoice=="scissors" && pChoice=="lizard" || cChoice=="paper" && pChoice=="rock" || cChoice=="scissors" && pChoice=="paper" || cChoice=="lizard" && pChoice=="spock" || cChoice=="spock" && pChoice=="rock" || cChoice=="spock" && pChoice=="scissors" || cChoice=="paper" && pChoice=="spock"){
